...
export default function PanelLayout({
    ...
    return (
        <div className="flex h-screen overflow-hidden bg-[#f5f5f7]">
            <AuthSync />
            <OnboardingCheck />
            {/* Sidebar handles its own second-panel rendering */}
            <Sidebar />
            <div id="panel-main-content" className="flex-1 flex flex-col h-full overflow-hidden relative transition-all duration-300 ml-[72px] lg:ml-16">
                <ModernHeader />
