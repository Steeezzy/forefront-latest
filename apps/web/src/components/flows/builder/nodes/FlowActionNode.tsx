    ...
    return (
        <div className="relative group">
            ...
            <div className={`bg-[#ffffff] rounded-xl border w-56 overflow-hidden transition-all cursor-pointer
                ${selected ? 'border-blue-400 shadow-[0_0_16px_rgba(59,130,246,0.2)]' : 'border-gray-200 hover:border-blue-500/50'}
                ...
                <div className="p-3 flex items-center gap-3">
                    <div className="w-9 h-9 rounded-lg flex items-center justify-center text-gray-900 bg-blue-600 shrink-0">
                        <IconComp size={20} />
                    </div>
