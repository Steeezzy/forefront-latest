...
export function AudiencesSettings() {
    return (
        <>
            {/* Banner */}
            <div className="bg-[#ffffff] border border-gray-200 rounded-xl p-6 mb-6 flex flex-col md:flex-row items-center justify-between gap-6">
                <div>
                    <h3 className="text-gray-900 font-bold mb-2">Use Conversa content to specific users</h3>
                    <p className="text-slate-400 text-sm mb-3 max-w-xl">
                        Create and manage custom audiences to control which knowledge Conversa uses — ensuring consistently relevant answers.
                    </p>
                    <a href="#" className="inline-flex items-center gap-2 text-blue-500 hover:text-blue-400 text-sm font-medium transition-colors">
                        <BookOpen size={16} />
                        How to use audiences to target Conversa
                    </a>
                </div>
            ...
            <div className="flex items-center justify-between mb-4">
                <h3 className="text-gray-900 font-bold text-lg">Audiences: 0</h3>
            ...
            {/* Empty State Table */}
            <div className="bg-[#ffffff] border border-gray-200 rounded-xl overflow-hidden min-h-[400px]">
                <div className="flex items-center border-b border-gray-200 px-6 py-4 bg-[#f9fafb]">
