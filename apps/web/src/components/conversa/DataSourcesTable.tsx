...
export function DataSourcesTable() {
    ...
    if (loading) {
        return (
            <div className="flex items-center justify-center p-12 bg-[#f8fafc] border border-gray-200 rounded-xl">
    ...
    return (
        <div className="border border-gray-200 rounded-xl overflow-hidden bg-[#f8fafc]">
            <div className="px-4 py-3 border-b border-gray-200 flex items-center justify-between">
                <span className="text-sm font-semibold text-gray-900">Results: {sources.length}</span>
            </div>
                        ...
                        {sources.length === 0 ? (
                            ...
                            sources.map((source) => (
                                <tr key={source.id} className="group hover:bg-white/5 transition-colors">
                                    ...
                                    <td className="p-4">
                                        <span className="px-2 py-1 rounded bg-[#f9fafb] text-slate-300 text-xs font-medium border border-gray-200">
                                            Everyone
                                        </span>
                                    </td>
                                    ...
                                    <td className="p-4 text-right">
                                        <button className="p-1 rounded hover:bg-white/10 text-slate-500 hover:text-gray-900 transition-colors">
