        ...
        <div className="flex flex-col gap-8 max-w-[800px]">
            ...
            <div className="space-y-2">
                ...
                <p className="text-xs text-slate-400 mb-2">
                    Choose a descriptive name that helps you identify this Action in your list. This name will also be used by Conversa as context for how it should operate.
                </p>
                <Input
                    placeholder="e.g. Check Order Status"
                    value={name}
                    onChange={(e) => setName(e.target.value)}
                    className="bg-black/20 border-gray-200 text-gray-900"
                />
            </div>
            ...
            <div className="space-y-2">
                ...
                <p className="text-xs text-slate-400 mb-2">
                    Give Conversa detailed instructions on how this Action should and shouldn't behave. Go into detail, so Conversa can really understand all use cases.
                </p>
                <Textarea
                    placeholder="E.g. Use this action when a user asks about their order..."
                    value={instructions}
                    onChange={(e) => setInstructions(e.target.value)}
                    className="bg-black/20 border-gray-200 text-gray-900 min-h-[150px] resize-y"
                />
            </div>
            ...
            <div className="space-y-2">
                ...
                <p className="text-xs text-slate-400 mb-2">
                    What tasks does Conversa need to perform, or what data does Conversa need to get from third-party software, to complete this Action?
                </p>

                <div className="border border-gray-200 rounded-xl bg-[#ffffff] p-6 flex items-center gap-6">
            ...
            <div className="space-y-2">
                ...
                <p className="text-xs text-slate-400 mb-2">
                    Data you choose to save from API calls. Select the information Conversa should access.
                </p>

                <div className="border border-gray-200 rounded-xl overflow-hidden">
                    <table className="w-full text-sm text-left">
                        <thead className="bg-[#ffffff] text-slate-400">
                            <tr>
                                <th className="px-4 py-3 font-medium">Type</th>
                                <th className="px-4 py-3 font-medium">Name</th>
                                <th className="px-4 py-3 font-medium">Available for Conversa</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr className="border-t border-gray-200 bg-black/20">
            ...
            <div className="flex flex-col gap-6 pt-6 border-t border-gray-200">
                ...
                <div className="flex items-center justify-between mt-4">
                    <Button variant="outline" className="border-gray-200 text-slate-300 hover:text-gray-900" onClick={() => router.push('/panel/chatbot/actions')}>
                        Cancel
                    </Button>
                    <div className="flex items-center gap-3">
                        <Button variant="outline" className="border-gray-200 text-slate-300 hover:text-gray-900">
                            Test it out
                        </Button>
                        <Button variant="outline" className="border-gray-200 text-slate-300 hover:text-gray-900" onClick={() => handleSaveAndClose(false)} disabled={isSaving}>
                            Save and close
                        </Button>
                        <Button className="bg-blue-600 hover:bg-blue-500 text-gray-900 border-0" onClick={() => handleSaveAndClose(true)} disabled={isSaving}>
                            Activate
                        </Button>
                    </div>
                </div>
