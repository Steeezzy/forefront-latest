...
export class CSVImportService {
     ...
     */
    async importFromCSV(agentId: string, csvBuffer: Buffer, name: string = 'CSV Import') {
        ...
        try {
            ...
            // Update total
            await pool.query(
                `UPDATE processing_jobs SET total_items = $2 WHERE id = $1`,
                [jobId, totalRows]
            );
