...
export default async function workspaceRoutes(app: FastifyInstance) {
    ...
    app.put('/settings', workspaceController.saveSettings.bind(workspaceController)); // Fix for Issue 1
    app.get('/:id/onboarding-status', workspaceController.getOnboardingStatus.bind(workspaceController)); // Fix for Issue 2
