...
export interface PlanDefinition {
  ...
  popular: boolean;
  limits: {
    monthlyCredits: number; // Unified Credit Pool
    voiceMinutes: number;   // Legacy UI field
    chatMessages: number;   // Legacy UI field
    agents: number;
    campaigns: number;
...
export const RECHARGE_PACKS = [
  { id: 'pack_small', name: 'Small Pack', credits: 5000, price: 1500 },
  { id: 'pack_medium', name: 'Medium Pack', credits: 25000, price: 5000 },
  { id: 'pack_large', name: 'Large Pack', credits: 100000, price: 15000 },
];
...
export const PLANS: Record<string, PlanDefinition> = {
  free: {
    ...
    popular: false,
    limits: {
      monthlyCredits: 800, // Roughly 500 msgs + 30 voice mins (30*10 = 300)
      voiceMinutes: 30,
      chatMessages: 500,
      agents: 1,
      campaigns: 1,
  ...
  starter: {
    ...
    popular: false,
    limits: {
      monthlyCredits: 8000, // 5000 msg + 300 voice mins (300*10)
      voiceMinutes: 300,
      chatMessages: 5000,
      agents: 3,
      campaigns: 10,
  ...
  growth: {
    ...
    popular: true,
    limits: {
      monthlyCredits: 35000, // 25,000 msg + 1,000 voice mins (1000*10)
      voiceMinutes: 1000,
      chatMessages: 25000,
      agents: 10,
      campaigns: 50,
  ...
  pro: {
    ...
    popular: false,
    limits: {
      monthlyCredits: 150000, // 100,000 msg + 5,000 voice mins (5000*10)
      voiceMinutes: 5000,
      chatMessages: 100000,
      agents: 50,
      campaigns: 200,
