...
export async function customerRoutes(app: FastifyInstance) {
  ...
  // Update customer deal stage (Issue 3)
  app.put('/:workspaceId/:profileId/stage', customerController.updateDealStage.bind(customerController));

  // Get full customer detail (Issue 3)
  app.get('/:workspaceId/:profileId/detail', customerController.getDetail.bind(customerController));
