        ...
        <div className="flex min-h-screen bg-[#f8fafc] overflow-hidden h-screen">
            ...
            <div className="flex-1 overflow-y-auto h-full p-8 relative custom-scrollbar">
                <div className="max-w-[1000px] animate-in fade-in slide-in-from-bottom-2 duration-300">
                    ...
                    <h1 className="text-xl font-bold text-gray-900 mb-8">Notifications for Karthik J</h1>
                                ...
                                <div key={index} className="grid grid-cols-[2fr_1fr_1fr_2fr] gap-4 items-center px-4 py-3 hover:bg-white/5 rounded-lg transition-colors">
                                    ...
                                    <div className="flex justify-center">
                                        <div className={cn(
                                            ...
                                            item.email ? "bg-blue-600 border-blue-600" : "bg-[#f8fafc] border-zinc-700 hover:border-zinc-500",
                                            item.label === 'Incoming visitor' && "opacity-50 cursor-not-allowed"
                                        )}>
                                            {item.email && <Check size={14} className="text-gray-900" />}
                                    ...
                                    <div className="flex justify-center">
                                        <div className={cn(
                                            "w-5 h-5 rounded border flex items-center justify-center transition-colors cursor-pointer",
                                            item.web ? "bg-blue-600 border-blue-600" : "bg-[#f8fafc] border-zinc-700 hover:border-zinc-500"
                                        )}>
                                            {item.web && <Check size={14} className="text-gray-900" />}
                                        </div>
                                    </div>
                    ...
                    <div className="bg-[#ffffff] border border-gray-200 rounded-xl p-8">
                        <h2 className="text-lg font-bold text-gray-900 mb-2">Forward email notifications</h2>
                        ...
                        <Button className="bg-blue-600 hover:bg-blue-700 text-gray-900 px-6 py-2 rounded-lg font-medium">
                            Save
                        </Button>
                    </div>
