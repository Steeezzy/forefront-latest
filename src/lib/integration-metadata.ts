...
export interface IntegrationMeta {
  id: string;
  headline: string;        // "Get more done with Forefront and [X] Integration"
...
export const INTEGRATION_META: Record<string, IntegrationMeta> = {
  ...
  zapier: {
    id: 'zapier',
    headline: 'Get more done with Forefront and Zapier Integration',
    subtitle: 'Use Zapier to sync chats, leads, and customer details instantly across your entire tool stack.',
    overviewText: 'Link Forefront and Zapier to supercharge your workflow. Every contact, message, or bot response can be automatically forwarded to your CRM, spreadsheets, email tools, or other apps. Skip manual exports, respond to leads quickly, and keep operations running smoothly as volume grows.',
    keyFeatures: [
      'Send new leads where they belong — automatically push contacts from Forefront straight into your CRM or any other tool.',
      ...
      'Connect Forefront to thousands of apps — build simple automations to move data anywhere you need it.',
    ],
    setupSteps: [
      'Open the Flow editor in Forefront and add the "Send to Zapier" action to any flow.',
    ...
    faq: [
      { question: 'How do I set up Zapier with Forefront?', answer: 'Open Forefront\'s Flow editor, add the "Send to Zapier" action to any flow, then follow instructions to connect your Zapier account. Data from that flow will be sent automatically to your chosen app.' },
      ...
      { question: 'Do I need coding skills to use the integration?', answer: 'No. The integration works via Forefront\'s visual Flow editor and Zapier\'s no-code interface. You can build useful automations without writing a single line of code.' },
    ],
  ...
  'google-analytics': {
    id: 'google-analytics',
    headline: 'Get more done with Forefront and Google Analytics Integration',
    ...
    overviewText: 'Connect Forefront with Google Analytics and get a clear view of how visitors interact with your widget, conversations, and flows. Track key events like started chats, completed chats, and lead submissions directly in GA to understand what sparks engagement and where customers convert. Use real data to improve support quality and optimize your website without guesswork.',
    keyFeatures: [
      'Track user interactions with the Forefront widget, chats, and Flows inside Google Analytics.',
    ...
    setupSteps: [
      'Navigate to Integrations in the Forefront admin panel.',
      'Click on Google Analytics and enter your Google Tag ID (e.g. G-XXXXXXXXXX).',
      'Click Connect — Forefront immediately starts sending events to Google Analytics.',
      'View events in your GA4 property under Events.',
    ],
    faq: [
      { question: 'What events does Forefront send to Google Analytics?', answer: 'Forefront sends predefined events including chat started, chat finished, conversations triggered by flows, and leads collected. These help you understand engagement patterns and customer actions.' },
      { question: 'How do I connect Google Analytics to Forefront?', answer: 'Enter your Google Tag ID in the integration panel and click Connect. Once the widget is active on your site, events are sent immediately. No additional setup required.' },
      { question: 'Can I create custom conversions based on Forefront events?', answer: 'Yes. Any event Forefront sends to Google Analytics can be marked as a conversion, letting you track which conversations or Flows contribute to revenue or lead generation.' },
    ],
    tags: ['Analytics'],
  ...
  'google-tag-manager': {
    ...
    headline: 'Get more done with Forefront and Google Tag Manager Integration',
    subtitle: 'Streamline data tracking and customer engagement with seamless integration between Forefront and Google Tag Manager.',
    overviewText: 'Connect Google Tag Manager to capture every interaction with your Forefront widget and pass it to your existing analytics setup. Once enabled, Forefront automatically pushes widget events to the GTM dataLayer, so you can forward them to tools like Google Analytics or ad platforms. This keeps tracking consistent, reduces manual setup, and helps teams understand how chat impacts conversions and engagement.',
    keyFeatures: [
      'Automatically push Forefront widget events to the Google Tag Manager dataLayer.',
      'Track visitor interactions such as chat opens, messages, and availability changes.',
      'Enhance analytics of tools like Facebook, TikTok, Twitter with data from Forefront widget for better insights.',
      'Reuse Forefront events in analytics and advertising tools connected to GTM.',
    ...
    setupSteps: [
      ...
      'Click Connect — Forefront will immediately start pushing events to the dataLayer.',
      'Configure tags and triggers in your GTM account to forward the events.',
    ],
    faq: [
      { question: 'What exactly happens after I enable the Google Tag Manager integration?', answer: 'Once enabled, Forefront automatically pushes all widget-related events to the Google Tag Manager dataLayer. Every time a visitor interacts with the widget, the event is sent immediately and becomes available inside GTM for further use.' },
  ...
  facebook: {
    id: 'facebook',
    headline: 'Get more done with Forefront and Facebook Integration',
    subtitle: 'Handle Messenger messages and comments from your customers directly in your panel.',
    overviewText: 'Connect your Facebook Business Page with Forefront and manage all incoming Messenger conversations and page comments from a single inbox. Respond to customers in real time, assign chats to team members, and use automation to handle common questions — all without switching between tools.',
    keyFeatures: [
      'Receive and reply to Facebook Messenger messages directly in the Forefront inbox.',
    ...
    setupSteps: [
      'Go to Settings → Channels in the Forefront panel.',
      'Click Connect Facebook and authorize your Facebook Business Page.',
      'Select which pages you want to receive messages from.',
      'Messenger conversations will start appearing in your Forefront inbox.',
    ],
    faq: [
      { question: 'What Facebook features are supported?', answer: 'You can receive and reply to Messenger direct messages and respond to page comments. All conversations appear in the Forefront unified inbox alongside other channels.' },
      ...
      { question: 'Can I automate responses to Messenger messages?', answer: 'Yes. You can use Forefront Flows to automatically respond to common Messenger questions, qualify leads, and route conversations to the right agents.' },
    ],
  ...
  email: {
    id: 'email',
    headline: 'Get more done with Forefront and Email Integration',
    subtitle: 'Connect your mailbox and receive or send emails directly from the app.',
    overviewText: 'With Forefront, you can connect your email inbox and handle all email conversations alongside live chat, Messenger, and other channels in one unified dashboard. Never miss a customer inquiry again — every email becomes a conversation thread your team can assign, tag, and resolve.',
    keyFeatures: [
      'Receive and send emails directly from the Forefront inbox.',
    ...
    setupSteps: [
      ...
      'Incoming emails will start appearing in your Forefront inbox.',
    ],
    faq: [
      { question: 'Which email providers are supported?', answer: 'Forefront supports Gmail, Outlook, and any IMAP/SMTP email provider. OAuth-based connection is available for Gmail and Outlook.' },
      { question: 'Will emails still appear in my regular inbox?', answer: 'Yes. Forefront creates a copy of incoming emails in its inbox. Your original email inbox remains unchanged.' },
      { question: 'Can I send emails from Forefront?', answer: 'Yes. You can compose and reply to emails directly from the Forefront panel using your connected email address.' },
    ],
    tags: ['Messaging', 'Omnichannel Inbox'],
  ...
  instagram: {
    id: 'instagram',
    headline: 'Get more done with Forefront and Instagram Integration',
    subtitle: 'Reply to Direct Messages, Stories, and comments from your Instagram Business account.',
    overviewText: 'Connect your Instagram Business account with Forefront and manage all Instagram customer interactions from a single inbox. Reply to Direct Messages, respond to Story mentions, and manage comments — all without switching between apps. Use automation to handle common questions and route conversations to the right agents.',
    keyFeatures: [
      'Receive and reply to Instagram Direct Messages in the Forefront inbox.',
    ...
    faq: [
      ...
      { question: 'Can I automate Instagram responses?', answer: 'Yes. You can use Forefront Flows to automatically respond to common Instagram questions, qualify leads, and route conversations.' },
    ],
    tags: ['Messaging', 'Omnichannel Inbox'],
  ...
  whatsapp: {
    id: 'whatsapp',
    headline: 'Get more done with Forefront and WhatsApp Integration',
    subtitle: 'Automate your WhatsApp communication to speed up response times with a personal, human touch.',
    overviewText: 'Integrate Forefront with WhatsApp Business and manage all WhatsApp conversations from your unified inbox. Turn conversations into support tickets or sales opportunities. Combine smart automation with a personal, human touch to deliver exceptional customer experiences at scale.',
    keyFeatures: [
      'Receive and reply to WhatsApp messages directly in the Forefront inbox.',
    ...
    faq: [
      ...
      { question: 'Are automated responses supported?', answer: 'Yes. You can use Forefront Flows to automatically respond to common questions, qualify leads, and route conversations to the right agents.' },
    ],
    tags: ['Messaging', 'Omnichannel Inbox'],
  ...
  'agile-crm': {
    id: 'agile-crm',
    headline: 'Get more done with Forefront and Agile CRM Integration',
    subtitle: 'Create new contacts straight from the conversation and keep your CRM updated automatically.',
    overviewText: 'Connect Forefront with Agile CRM to automatically create and update contacts whenever a visitor chats with your team. Map contact fields between both platforms, sync conversation history, and give your agents full context without switching tools.',
    keyFeatures: [
      'Auto-create new contacts in Agile CRM from chat conversations.',
      'Sync contact properties with configurable field mapping.',
      'View Agile CRM contact details inside the Forefront panel during conversations.',
    ...
    setupSteps: [
      ...
      'Click Connect — Forefront will test the connection automatically.',
    ...
    faq: [
      ...
      { question: 'Can I control which fields sync?', answer: 'Yes. Use the Field Mapping editor in the Settings tab to map Forefront fields to Agile CRM fields.' },
  ...
  'zendesk-sell': {
    id: 'zendesk-sell',
    headline: 'Get more done with Forefront and Zendesk Sell Integration',
    subtitle: 'Create new leads straight from the conversation and keep your sales pipeline updated.',
    overviewText: 'Connect Forefront with Zendesk Sell to push new leads directly into your sales pipeline. Every chat conversation can become a qualified lead in your CRM. Map contact fields, sync conversation history, and keep your sales team informed without extra manual work.',
    keyFeatures: [
      'Auto-create new leads in Zendesk Sell from chat conversations.',
      'Sync contact properties with configurable field mapping.',
      'View Zendesk Sell lead details inside the Forefront panel.',
      'Send chat transcripts to CRM when conversations are resolved.',
    ...
    setupSteps: [
      ...
      'Click Connect — Forefront will verify the connection.',
  ...
  pipedrive: {
    id: 'pipedrive',
    headline: 'Get more done with Forefront and Pipedrive Integration',
    subtitle: 'Create new deals straight from the conversation and keep your pipeline moving.',
    overviewText: 'Connect Forefront with Pipedrive to automatically create persons and deals whenever a visitor chats with your team. Map contact fields, sync conversation history, and give your sales team full context without leaving the chat panel.',
    keyFeatures: [
      'Auto-create persons and deals in Pipedrive from chat conversations.',
      'Sync contact properties with configurable field mapping.',
      'View Pipedrive contact details inside the Forefront panel.',
      'Send chat transcripts to CRM when conversations are resolved.',
      'OAuth-based connection for secure authentication.',
    ],
    setupSteps: [
      'Navigate to Integrations and click Pipedrive.',
      'Click "Connect with OAuth" to authorize Forefront with your Pipedrive account.',
      'Alternatively, enter your API Token manually.',
      'Configure field mappings in the Settings tab if needed.',
    ],
    faq: [
      { question: 'Can I use OAuth to connect?', answer: 'Yes. Pipedrive supports OAuth-based authentication. Click "Connect with OAuth" and authorize Forefront in your Pipedrive account.' },
      { question: 'Are deals created automatically?', answer: 'Yes. When auto-sync is enabled, Forefront creates deals in your default pipeline for each new qualified conversation.' },
      { question: 'Can I map custom fields?', answer: 'Yes. Use the Field Mapping editor to map Forefront contact fields to any Pipedrive person or deal field.' },
    ],
    tags: ['CRM', 'Lead Capture'],
  ...
  zoho: {
    id: 'zoho',
    headline: 'Get more done with Forefront and Zoho CRM Integration',
    subtitle: 'Create new contacts straight from the conversation and keep your CRM organized.',
    overviewText: 'Connect Forefront with Zoho CRM to automatically create and update contacts whenever a visitor chats. Map contact fields between platforms, view CRM data in the chat panel, and give agents full context for every conversation.',
    keyFeatures: [
      'Auto-create new contacts in Zoho CRM from chat conversations.',
      'Sync contact properties with configurable field mapping.',
      'View Zoho CRM contact details inside the Forefront panel.',
      'Send chat transcripts to CRM when conversations are resolved.',
  ...
  hubspot: {
    id: 'hubspot',
    headline: 'Get more done with Forefront and HubSpot Integration',
    subtitle: 'Capture new leads and turn prospects into customers without any hassle, keeping your CRM updated automatically.',
    overviewText: 'Link your Forefront live chat to HubSpot CRM to keep your contacts and conversation records in sync. Whenever a visitor chats or signs up via Forefront, their information flows automatically to HubSpot, reducing manual entry. This means fewer errors, faster follow-ups, and a more organized CRM.',
    keyFeatures: [
      'Auto-create new contacts — subscribers captured in Forefront are added as contacts in HubSpot automatically.',
      'Sync existing contact data — map and update contact properties (email, name, phone, etc.) from Forefront to HubSpot fields.',
      ...
      'Access HubSpot contacts without leaving Forefront — see contact details directly inside the panel.',
      'Manual or custom mapping — customize which Forefront contact properties map to which HubSpot fields.',
    ],
    setupSteps: [
    ...
    faq: [
      { question: 'How do I connect Forefront with HubSpot?', answer: 'Navigate to Integrations, click HubSpot, click "Connect with OAuth", authorize the connection, choose your HubSpot account, optionally map properties, and click Finish.' },
      { question: 'Can I control which contact fields sync?', answer: 'Yes. During setup or afterwards in Settings, you can map standard and custom Forefront fields to corresponding HubSpot properties.' },
      { question: 'Does HubSpot data appear during a conversation?', answer: 'Yes. When a visitor already exists in HubSpot, you can see their contact details right inside the Forefront panel, giving agents full context without switching tools.' },
    ],
    tags: ['CRM', 'Lead Capture'],
  ...
  salesforce: {
    id: 'salesforce',
    headline: 'Get more done with Forefront and Salesforce Integration',
    subtitle: 'Sync customer conversations, contacts, and context between Forefront and Salesforce automatically.',
    overviewText: 'Bring customer conversations and CRM data together in one smooth flow. The Forefront and Salesforce integration automatically creates or updates contacts and saves conversation history as notes. Your team gets less manual work, cleaner data, and full context for every follow-up — all without changing how they work day to day.',
    keyFeatures: [
      'Automatically create and update Salesforce contacts from Forefront conversations.',
      ...
      'Map selected contact properties between Forefront and Salesforce.',
    ...
    faq: [
      { question: 'What happens after I connect Forefront with Salesforce?', answer: 'Customer conversations start feeding your CRM automatically. New contacts are created or updated, and conversation history is saved so your team always has context in Salesforce.' },
  ...
  bigcommerce: {
    id: 'bigcommerce',
    headline: 'Get more done with Forefront and BigCommerce Integration',
    subtitle: 'Provide an excellent shopping experience and turn visitors into happy customers.',
    overviewText: 'Connect Forefront with your BigCommerce store to deliver personalized support right where customers shop. See order history, answer product questions, and use automation to recover abandoned carts — all from one dashboard.',
    keyFeatures: [
      'View customer order history directly in the chat panel.',
      'Look up orders by email or order ID without leaving Forefront.',
      'Answer product questions with full store context at your fingertips.',
      'Use Flow automations to proactively engage shoppers.',
      'Sync customer data between Forefront and BigCommerce.',
    ],
    setupSteps: [
  ...
  'adobe-commerce': {
    id: 'adobe-commerce',
    headline: 'Get more done with Forefront and Adobe Commerce Integration',
    subtitle: 'Increase your sales by reaching out to your customers with personalized communication.',
    overviewText: 'Connect Forefront with Adobe Commerce (Magento) to deliver personalized support across your store. Access order data, customer history, and product information right inside the chat panel.',
    keyFeatures: [
      'View customer order history directly in the chat panel.',
  ...
  prestashop: {
    id: 'prestashop',
    headline: 'Get more done with Forefront and PrestaShop Integration',
    subtitle: 'Talk to your online customers, gather new leads, and boost your sales in one go.',
    overviewText: 'Connect Forefront with PrestaShop to chat with your store visitors in real time, view order information, and use automation to convert browsers into buyers.',
    keyFeatures: [
      'Add the Forefront chat widget to your PrestaShop store.',
      ...
      'Sync customer data between Forefront and PrestaShop.',
    ],
    setupSteps: [
      'Navigate to Integrations and click PrestaShop.',
      'Enter your PrestaShop Store URL and API Key.',
      'Click Connect — Forefront verifies the connection.',
  ...
  shopify: {
    id: 'shopify',
    headline: 'Get more done with Forefront and Shopify Integration',
    subtitle: 'Chat with your visitors and increase sales by turning them into happy customers.',
    overviewText: 'Bring Forefront to your Shopify store to answer product questions, recover abandoned carts, and build trust through authentic support. Use dedicated Shopify features like cart preview, order management from inbox, and 40+ no-code automation templates to create outstanding shopping experiences.',
    keyFeatures: [
      ...
      'Automate common questions about products, delivery, and returns with Lyro AI.',
    ],
    setupSteps: [
      'Open Forefront in the Shopify App Store and install the dedicated app.',
      'Create and configure your Forefront account.',
      'Activate the Forefront app in your Shopify admin panel.',
    ],
    faq: [
      { question: 'Can I see what customers have in their cart?', answer: 'Yes. Forefront shows real-time cart preview so you can recommend products, send discounts, and respond to purchase-related questions faster.' },
      { question: 'Can I manage orders from Forefront?', answer: 'Yes. You can cancel orders, offer refunds, and change shipping addresses directly from your Forefront inbox without leaving the dashboard.' },
      { question: 'Does Forefront work with multiple Shopify stores?', answer: 'Yes. You can connect multiple Shopify stores and monitor all messages from a unified dashboard.' },
    ],
    tags: ['Ecommerce'],
  ...
  woocommerce: {
    id: 'woocommerce',
    headline: 'Get more done with Forefront and WooCommerce Integration',
    subtitle: 'Supercharge your WooCommerce store with seamless chat integration and real-time product sharing.',
    overviewText: 'Connect Forefront with WooCommerce to engage your website visitors at the right time. View order and customer data in real-time, look up orders during conversations, and use automation to make sure visitors finalize their purchases.',
    keyFeatures: [
      ...
      'Sync customer data between Forefront and WooCommerce.',
    ],
    setupSteps: [
  ...
  wordpress: {
    id: 'wordpress',
    headline: 'Get more done with Forefront and WordPress Integration',
    subtitle: 'Deliver authentic, efficient support on WordPress with trustworthy AI and human-centred tools.',
    overviewText: 'Add the Forefront chat widget to your WordPress site in seconds. Engage visitors in real time, answer questions, and capture leads — all without leaving your WordPress dashboard. Simply paste the widget snippet or install the plugin.',
    keyFeatures: [
    ...
    faq: [
      ...
      { question: 'Does it work with page builders?', answer: 'Yes. The Forefront widget works with any WordPress theme, Elementor, Divi, Gutenberg, and other page builders.' },
    ],
  ...
  klaviyo: {
    id: 'klaviyo',
    headline: 'Get more done with Forefront and Klaviyo Integration',
    subtitle: 'Automatically add new subscribers from chat to your Klaviyo mailing list.',
    overviewText: 'Connect Forefront with Klaviyo and grow your email list from every conversation. When visitors share their email through pre-chat surveys, Flows, or chat, they\'re automatically added to your chosen Klaviyo list — no manual work required.',
    keyFeatures: [
  ...
  mailchimp: {
    id: 'mailchimp',
    headline: 'Get more done with Forefront and Mailchimp Integration',
    subtitle: 'Automatically send new contacts to your Mailchimp list and keep subscribers organized effortlessly.',
    overviewText: 'Connect Forefront with Mailchimp to grow your mailing list from every conversation. Add subscribers instantly from pre-chat surveys, Flows, or manual updates. No extra steps, no juggling tools. Keep your email database clean, updated, and ready for personalized communication.',
    keyFeatures: [
      'Add subscribers from pre-chat surveys when visitors share their email.',
      'Collect emails in Flows using the Subscribe for Mailing action.',
    ...
    faq: [
      { question: 'How do I add new subscribers from Forefront to Mailchimp?', answer: 'Visitors can be added through pre-chat surveys, automated Flows with the Subscribe for Mailing action, or by manually updating a contact\'s subscriber status. All updates sync to your Mailchimp list.' },
      ...
      { question: 'Do I need technical skills?', answer: 'No. The Mailchimp integration installs in a few clicks, and you can manage subscribers directly from the Forefront panel without extra configuration.' },
    ],
    tags: ['Email Marketing', 'Lead Capture'],
  ...
  activecampaign: {
    id: 'activecampaign',
    headline: 'Get more done with Forefront and ActiveCampaign Integration',
    subtitle: 'Automatically add new subscribers from chat to your ActiveCampaign lists.',
    overviewText: 'Connect Forefront with ActiveCampaign to keep your marketing lists growing with every conversation. Subscribers collected through chat, pre-chat surveys, and Flows are automatically synced to your ActiveCampaign account.',
    keyFeatures: [
      'Add subscribers from pre-chat surveys when visitors share their email.',
      'Collect emails in Flows using the Subscribe for Mailing action.',
  ...
  omnisend: {
    id: 'omnisend',
    headline: 'Get more done with Forefront and Omnisend Integration',
    subtitle: 'Automatically add new subscribers from chat to your Omnisend mailing list.',
    overviewText: 'Connect Forefront with Omnisend and automatically sync subscribers from chat conversations, pre-chat surveys, and Flows. Keep your email and SMS marketing lists growing with zero manual effort.',
    keyFeatures: [
      'Add subscribers from pre-chat surveys when visitors share their email.',
      'Collect emails in Flows using the Subscribe for Mailing action.',
  ...
  mailerlite: {
    id: 'mailerlite',
    headline: 'Get more done with Forefront and MailerLite Integration',
    subtitle: 'Automatically add new subscribers from chat to your MailerLite mailing list.',
    overviewText: 'Connect Forefront with MailerLite to grow your subscriber list from every conversation. Emails collected through pre-chat surveys, Flows, and manual updates sync automatically to MailerLite.',
    keyFeatures: [
      'Add subscribers from pre-chat surveys when visitors share their email.',
      'Collect emails in Flows using the Subscribe for Mailing action.',
  ...
  brevo: {
    id: 'brevo',
    headline: 'Get more done with Forefront and Brevo Integration',
    subtitle: 'Automatically add new subscribers from chat to your Brevo (formerly Sendinblue) mailing list.',
    overviewText: 'Connect Forefront with Brevo to keep your marketing lists growing with every customer interaction. Subscribers from pre-chat surveys, Flows, and chat conversations sync automatically to Brevo.',
    keyFeatures: [
      'Add subscribers from pre-chat surveys when visitors share their email.',
      'Collect emails in Flows using the Subscribe for Mailing action.',
  ...
  judgeme: {
    id: 'judgeme',
    headline: 'Get more done with Forefront and Judge.me Integration',
    subtitle: 'Collect more reviews and build trust with your customers.',
    overviewText: 'Connect Judge.me with Forefront to collect product reviews directly through chat conversations. Build social proof, encourage repeat purchases, and give customers an easy way to share their experience.',
    keyFeatures: [
    ...
    faq: [
      { question: 'Where do I find my Judge.me API token?', answer: 'In your Judge.me dashboard, go to Settings → API → API Token. Copy the token and paste it in Forefront.' },
  ...
  zendesk: {
    id: 'zendesk',
    headline: 'Get more done with Forefront and Zendesk Integration',
    subtitle: 'Create new tickets from the chat window and manage them in Zendesk.',
    overviewText: 'Easily create Zendesk tickets from any Forefront chat and keep every issue organized with full customer details. When a conversation requires follow-up, turn it into a Zendesk ticket with a single click — complete with chat history and customer context.',
    keyFeatures: [
      'Create Zendesk tickets directly from chat conversations.',
      'Include full chat transcript and customer details in tickets.',
      'Search and view existing Zendesk tickets from the Forefront panel.',
      'Add comments to existing tickets without leaving Forefront.',
    ...
    faq: [
      ...
      { question: 'Can I update tickets from Forefront?', answer: 'Yes. You can add comments to existing Zendesk tickets directly from the Forefront panel.' },
    ],
  ...
  slack: {
    id: 'slack',
    headline: 'Get more done with Forefront and Slack Integration',
    subtitle: 'Get real-time notifications in Slack for new conversations, tickets, and ratings.',
    overviewText: 'Keep your team in the loop with real-time Slack notifications for every important event in Forefront. Get alerted about new conversations, ticket updates, customer ratings, and offline messages — all delivered to the Slack channels your team already monitors.',
    keyFeatures: [
    ...
    setupSteps: [
      ...
      'Click Connect — Forefront will send a test message to verify.',
