...
export function ManualQnAModal({ isOpen, onClose }: ManualQnAModalProps) {
    ...
    const [usedBy, setUsedBy] = useState({ conversa: true, copilot: true });
    ...
    return (
        <>
            ...
            {/* Side Panel */}
            <div className="fixed top-0 right-0 h-full w-full max-w-[720px] bg-[#f8fafc] border-l border-zinc-800 z-50 flex flex-col shadow-2xl animate-in slide-in-from-right duration-300">
                {/* Header */}
                <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-800">
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            ...
                            className="bg-blue-600 hover:bg-blue-500 disabled:bg-zinc-700 disabled:text-zinc-500 text-gray-900 px-4 py-2 rounded-lg text-sm font-medium transition-colors flex items-center gap-2"
                        >
                        ...
                        <div>
                            ...
                            <div className="mb-4">
                                <input
                                    ...
                                    className="w-full px-4 py-3 rounded-lg bg-white border border-zinc-700 text-gray-900 placeholder-zinc-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors text-sm"
                                />
                            </div>
                            ...
                            <div className="relative">
                                <textarea
                                    ...
                                    placeholder="Answer"
                                    rows={12}
                                    className="w-full px-4 py-3 rounded-lg bg-white border border-zinc-700 text-gray-900 placeholder-zinc-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors text-sm resize-none"
                                />
                    ...
                    <div className="w-[240px] p-5 space-y-6 flex-shrink-0">
                        ...
                        <div>
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center justify-between cursor-pointer group">
                                    <span className="text-sm text-zinc-300 group-hover:text-gray-900 transition-colors">Conversa AI Agent</span>
                                    <div
                                        onClick={() => setUsedBy(prev => ({ ...prev, conversa: !prev.conversa }))}
                                        className={`w-8 h-[18px] rounded-full relative transition-colors cursor-pointer ${usedBy.conversa ? "bg-blue-600" : "bg-zinc-700"
                                            }`}
                                    >
                                        <div className={`absolute top-[2px] w-[14px] h-[14px] rounded-full bg-white transition-all ${usedBy.conversa ? "left-[16px]" : "left-[2px]"
                                            }`} />
                                    </div>
                                </label>
                                <label className="flex items-center justify-between cursor-pointer group">
                                    <span className="text-sm text-zinc-300 group-hover:text-gray-900 transition-colors">Copilot</span>
                                    <div
                        ...
                        <div>
                            ...
                            <p className="text-[10px] text-zinc-600 mt-2 leading-relaxed">
                                Conversa AI Agent and Copilot will use the same audience.
                            </p>
                        </div>
                    </div>
                </div>
