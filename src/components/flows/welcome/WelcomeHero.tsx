...
export function WelcomeHero() {
    return (
        <div className="flex flex-col items-center justify-center min-h-[calc(100vh-100px)]">
            <div className="bg-[#ffffff] border border-gray-200 rounded-xl p-12 text-center max-w-4xl w-full flex flex-col items-center">
                ...
                <div className="w-full max-w-lg mx-auto mb-8 relative">
                    ...
                    <div className="bg-[#f8fafc] border-x border-b border-zinc-800 h-64 w-full rounded-b-lg relative p-4 overflow-hidden">
                        {/* Abstract content */}
                        <div className="flex gap-4 h-full">
                            ...
                            <div className="w-2/3 space-y-3">
                                ...
                                {/* Chat Widget Pop */}
                                <div className="absolute bottom-6 right-6 bg-[#ffffff] border border-gray-200 p-4 rounded-xl shadow-2xl w-48 text-left z-10 animate-in slide-in-from-bottom duration-700">
                ...
                <h1 className="text-2xl font-bold text-gray-900 mb-2">Reduce your support volume by 32%</h1>
                <p className="text-zinc-400 max-w-md mx-auto mb-8">
                    Encourage self-service with pre-designed conversation pathways.
                </p>

                <Button className="bg-blue-600 hover:bg-blue-500 text-gray-900 rounded-full px-8 py-6 text-base font-medium mb-6">
                ...
                {/* Footer Tip */}
                <div className="bg-[#f8fafc] border border-gray-200 rounded-lg p-4 flex items-start text-left gap-3 max-w-2xl w-full">
                    <Sparkles className="text-zinc-500 flex-shrink-0 mt-0.5" size={16} />
                    <div>
                        <h4 className="text-gray-900 text-sm font-semibold mb-1">Advanced Return Requests</h4>
