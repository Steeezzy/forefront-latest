    ...
    return (
        <div className="relative group">
            ...
            <div className={`bg-[#18181b] rounded-xl border w-56 overflow-hidden transition-all cursor-pointer
                ${selected ? 'border-orange-400 shadow-[0_0_16px_rgba(251,146,60,0.2)]' : 'border-white/10 hover:border-orange-400/50'}
                ...
                <div className="p-3 flex items-center gap-3">
                    <div className="w-9 h-9 rounded-lg flex items-center justify-center text-white bg-orange-500 shrink-0">
                        <GitBranch size={20} />
                    </div>
