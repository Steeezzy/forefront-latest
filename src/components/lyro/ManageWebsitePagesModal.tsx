...
export function ManageWebsitePagesModal({ isOpen, onClose }: ManageWebsitePagesModalProps) {
    ...
    return (
        <>
            ...
            {/* Modal */}
            <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl max-h-[85vh] bg-[#0f1115] border border-zinc-800 rounded-xl z-50 flex flex-col shadow-2xl">
                {/* Header */}
                        ...
                        {!selectedSource ? (
                            ...
                            <div className="p-4">
                                ...
                                <div className="flex items-center justify-between mb-4 pb-4 border-b border-zinc-800">
                                    <div>
                                        <h3 className="text-white font-medium">{selectedSource.name}</h3>
                                        <a
                                ...
                                {pages.length === 0 ? (
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        {pages.map(page => (
                                            <div
                                                key={page.id}
                                                className="p-3 bg-zinc-900 border border-zinc-800 rounded-lg hover:border-zinc-700 transition-colors group"
                                            >
