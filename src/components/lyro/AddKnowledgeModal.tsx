    ...
    const options = [
        {
            id: 'website',
            title: 'Website URL',
            description: 'Provide the URL of your site to feed Lyro with knowledge from it.',
            icon: Globe,
    ...
    return (
        <>
            <Dialog open={isOpen} onOpenChange={onClose}>
                <DialogContent className="max-w-4xl bg-[#18181b] border-zinc-800 text-white p-0 overflow-hidden">
                    <div className="p-6 pb-2">
                        <DialogHeader>
                            <DialogTitle className="text-xl font-bold text-white mb-2">Add more knowledge</DialogTitle>
                    ...
                    <div className="bg-zinc-900/50 p-4 border-t border-zinc-800 flex items-center gap-2 text-xs text-zinc-500">
                        <Info className="w-3 h-3" />
                        <span>Difficulty finding the right option? With Plus plan, we can train Lyro for you using any source. <span className="text-zinc-300 font-medium cursor-pointer hover:underline">Contact us</span></span>
                    </div>
                </DialogContent>
            </Dialog>
