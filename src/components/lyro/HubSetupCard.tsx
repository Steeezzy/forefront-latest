...
import { TestLyroModal } from './TestLyroModal';
...
export function HubSetupCard() {
    ...
    return (
        <>
                ...
                <div className="flex flex-col md:flex-row gap-8 items-center bg-[#0f1115] rounded-xl p-6 border border-white/5">
                    ...
                    <div className="flex-1 space-y-4 w-full">
                        ...
                        <div className="flex items-center gap-3 cursor-pointer" onClick={() => setIsTestOpen(true)}>
                            ...
                            <span className="text-white font-medium hover:text-blue-400 transition-colors">Test Lyro AI Agent</span>
                        </div>
            ...
            <TestLyroModal isOpen={isTestOpen} onClose={() => setIsTestOpen(false)} />
        </>
    );
}
