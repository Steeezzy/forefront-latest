...
export class GoogleAnalyticsService {
  ...
  async trackEvent(
    ...
    await pool.query(
      `INSERT INTO analytics_widget_events (workspace_id, event_name, visitor_id, thread_id, source, parameters)
       VALUES ($1, $2, $3, $4, $5, $6)`,
      [workspaceId, eventName, params.visitorId, params.threadId, params.source, JSON.stringify(params)]
    );
  }
   ...
   */
  async getEvents(workspaceId: string, limit: number = 100, eventName?: string) {
   ...
   */
  async getEventCounts(workspaceId: string, since?: Date) {
