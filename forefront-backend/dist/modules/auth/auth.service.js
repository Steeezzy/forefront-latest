...
export class AuthService {
    async register(data) {
        ...
        try {
            ...
            const userRes = await client.query('INSERT INTO users (email, password_hash) VALUES ($1, $2) RETURNING id, email, created_at', [data.email, passwordHash]);
            const user = userRes.rows[0];
            // 3. Create Workspace
            const workspaceRes = await client.query('INSERT INTO workspaces (name, owner_id) VALUES ($1, $2) RETURNING id, name', [data.workspaceName, user.id]);
