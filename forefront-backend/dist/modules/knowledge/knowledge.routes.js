...
export async function knowledgeRoutes(app) {
     ...
     */
    app.get('/:agentId', { preHandler: [authenticate] }, async (req, reply) => {
     ...
     */
    app.post('/manual-qna', { preHandler: [authenticate] }, async (req, reply) => {
        try {
     ...
     */
    app.post('/qna', { preHandler: [authenticate] }, async (req, reply) => {
        try {
     ...
     */
    app.get('/qna/:sourceId', { preHandler: [authenticate] }, async (req, reply) => {
        try {
     ...
     * Update a Q&A pair
     */
    app.put('/qna/:qnaId', { preHandler: [authenticate] }, async (req, reply) => {
        try {
     ...
     * Delete a Q&A pair
     */
    app.delete('/qna/:qnaId', { preHandler: [authenticate] }, async (req, reply) => {
        try {
            const { qnaId } = req.params;
     ...
     */
    app.post('/csv-import', { preHandler: [authenticate] }, async (req, reply) => {
        try {
     ...
     */
    app.get('/csv-template', async (_req, reply) => {
     ...
     */
    app.post('/zendesk', { preHandler: [authenticate] }, async (req, reply) => {
        try {
     ...
     */
    app.get('/sources', { preHandler: [authenticate] }, async (req, reply) => {
        try {
     ...
     */
    app.get('/sources/:id', { preHandler: [authenticate] }, async (req, reply) => {
        try {
            const { id } = req.params;
     ...
     */
    app.get('/sources/:id/status', { preHandler: [authenticate] }, async (req, reply) => {
        try {
            const { id } = req.params;
            const result = await pool.query(`SELECT * FROM processing_jobs
