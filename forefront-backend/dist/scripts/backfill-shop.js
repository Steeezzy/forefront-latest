...
async function backfill() {
    ...
    try {
        const result = await pool.query(`INSERT INTO shopify_configs (workspace_id, shop_domain, access_token, backend_url, chatbot_id, is_active)
       ...
       RETURNING id`, [workspaceId, shop, accessToken, backendUrl, chatbotId]);
...
//# sourceMappingURL=backfill-shop.js.map