 ...
 */
export type ShopifyFinancialStatus = 'pending' | 'authorized' | 'partially_paid' | 'paid' | 'partially_refunded' | 'refunded' | 'voided';
export type ShopifyFulfillmentStatus = 'unfulfilled' | 'partial' | 'fulfilled' | 'restocked' | null;
export type ShopifyWebhookTopic = 'orders/create' | 'orders/updated' | 'orders/cancelled' | 'orders/fulfilled' | 'orders/paid' | 'customers/create' | 'customers/update' | 'checkouts/create' | 'checkouts/update' | 'refunds/create' | 'fulfillments/create' | 'app/uninstalled' | 'products/update';
