...
export type GuardrailType = 'topic_block' | 'keyword_filter' | 'pii_detection' | 'confidence_gate' | 'custom_regex';
...
export type HandoffTrigger = 'low_confidence' | 'customer_request' | 'repeated_failure' | 'sentiment_negative' | 'guardrail_block' | 'topic_unsupported' | 'agent_escalation_rule';
...
export type CopilotSuggestionType = 'reply_draft' | 'kb_article' | 'quick_action' | 'tone_rephrase';
